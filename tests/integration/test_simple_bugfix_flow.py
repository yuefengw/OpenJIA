...
class TestSimpleBugfixFlow:
    """Test a simple bugfix through the full OpenJIA flow."""
...
""")
    ...
    def test_evaluation_gate_handles_pass(self):
        ...
        from openjia.gates.evaluation_gate import EvaluationGate
        from openjia.schemas.eval_report import EvalReport, CriterionResult
